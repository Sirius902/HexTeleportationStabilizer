...
public class StabilizerMod {
    ...
    public static final DeferredBlock<Block> BLOCK_TELEPORT_STABILIZER = BLOCKS.registerSimpleBlock("teleport_stabilizer", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
